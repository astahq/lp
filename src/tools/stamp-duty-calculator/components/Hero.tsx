  ...
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img src={heroBg} alt="UK Property" className="h-full w-full object-cover" />
      ...
      <div className="container relative z-10 py-20 md:py-32">
        <div className="max-w-2xl">
          ...
          <h1 className="text-4xl font-bold leading-tight tracking-tight md:text-5xl lg:text-6xl">
            Calculate Your <span className="text-primary">UK Stamp Duty</span> Instantly
          </h1>
          
          <p className="mt-6 text-lg text-muted-foreground md:text-xl">
            Work out exactly how much stamp duty you'll pay on your UK property purchase. 
            Covers England, Scotland, and Wales with first-time buyer relief.
          </p>
